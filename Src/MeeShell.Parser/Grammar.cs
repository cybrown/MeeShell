...
namespace MeeShell.Parser
{
    public static class Grammar
    {
        ...
        public static IParser<ParserContext, CommandNode> ExpressionCommand =
            Lazy(() => CommandStatement.Between(
        ...
        public static readonly IParser<ParserContext, IAstNode> Block =
            Lazy(() => ManySeperatedBy(
                CommandStatement,
        ...
        public static readonly IParser<ParserContext, IAstNode> MemberExpression =
            SubExpression.Then(Many(FirstOf(
                ...
                .Map(n =>
                {
                    ...
                    foreach (var node in n.Item2)
                    {
                        if (node.Item1 == "dot")
                        {
                            currentNode = new MemberNode(currentNode, node.Item2 as IdentifierNode);
                        }
        ...
        public static readonly IParser<ParserContext, CommandNode> CommandStatement =
            BinaryExpressionAddSub.Then(Opt(Expression))
