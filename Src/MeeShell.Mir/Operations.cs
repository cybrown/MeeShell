...
namespace MeeShell.Mir
{
    ...
    public class OperationMember : IOperation
    {
        public string Name { get; }

        public OperationMember(string name)
        {
            Name = name;
        }
    ...
    public class OperationPushBlock : IOperation
    {
        public List<IOperation> Operations { get; }

        public OperationPushBlock(List<IOperation> Operations)
        {
